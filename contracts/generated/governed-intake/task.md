...
<!-- Generated from contracts/governed-intake-body.v1.json (GovernedIntakeBodyV1 version 18). Do not hand-edit; run: node --experimental-strip-types contracts/governed-intake-body.generate.ts -->
...
## Triage checklist
<!-- governed-triage-checklist: revision=18 -->
