...
There is no public support channel for this account — every repository is privately owned and
...
- Human escalation for anything time-sensitive goes through the fleet's ntfy.sh channel, not
  GitHub — see the operating repository's own docs for that path.
